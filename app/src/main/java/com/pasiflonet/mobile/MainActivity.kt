...
class MainActivity : BaseActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_intel_feed -> { startActivity(Intent(this, IntelFeedActivity::class.java)); true }
            R.id.action_radar -> { startActivity(Intent(this, RadarActivity::class.java)); true }
